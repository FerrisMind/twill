...
use crate::tokens::{Color, Scale, Spacing, BorderRadius, FontSize, FontWeight, Shadow};
...
impl Button {
    pub fn new(variant: ButtonVariant, size: ButtonSize) -> Self {
        Self { variant, size, disabled: false, full_width: false }
    }
    
    pub fn primary() -> Self { Self::new(ButtonVariant::Primary, ButtonSize::Md) }
    pub fn secondary() -> Self { Self::new(ButtonVariant::Secondary, ButtonSize::Md) }
    pub fn outline() -> Self { Self::new(ButtonVariant::Outline, ButtonSize::Md) }
    pub fn ghost() -> Self { Self::new(ButtonVariant::Ghost, ButtonSize::Md) }
    pub fn destructive() -> Self { Self::new(ButtonVariant::Destructive, ButtonSize::Md) }
    
    pub fn sm(mut self) -> Self { self.size = ButtonSize::Sm; self }
    pub fn lg(mut self) -> Self { self.size = ButtonSize::Lg; self }
    pub fn icon(mut self) -> Self { self.size = ButtonSize::Icon; self }
    ...
    fn base_style(&self) -> Style {
        Style::new()
            ...
            .flex(crate::utilities::FlexContainer::row()
    ...
    fn variant_style(&self) -> Style {
        match self.variant {
            ...
            ButtonVariant::Outline => Style::new()
                .text_color(Color::gray(Scale::S900))
                .border(crate::tokens::BorderWidth::S1, crate::tokens::BorderStyle::Solid, Color::gray(Scale::S200)),
    ...
    fn size_style(&self) -> Style {
        match self.size {
            ButtonSize::Sm => Style::new()
                .padding(crate::utilities::Padding::symmetric(Spacing::S1, Spacing::S3))
                .text_size(FontSize::Sm)
                .rounded(BorderRadius::Sm),
            ButtonSize::Md => Style::new()
                .padding(crate::utilities::Padding::symmetric(Spacing::S2, Spacing::S4))
                .text_size(FontSize::Sm),
            ButtonSize::Lg => Style::new()
                .padding(crate::utilities::Padding::symmetric(Spacing::S3, Spacing::S6))
                .text_size(FontSize::Base)
                .rounded(BorderRadius::Lg),
            ButtonSize::Icon => Style::new()
                .padding(crate::utilities::Padding::all(Spacing::S2)),
        }
    }
}
