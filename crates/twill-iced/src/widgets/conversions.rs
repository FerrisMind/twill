...
use twill_core::tokens::{
    ...
    Easing, FontSize, FontWeight, Percentage, SemanticColor, SemanticThemeVars, Shadow,
    ShadowColorToken, Spacing, TextAlign, TextColor, ThemeVariant, TransitionDuration,
};
use twill_core::traits::ComputeValue;
use twill_core::utilities::{MarginValue, ObjectFit, PaddingValue};
...
pub(crate) fn resolve_width(
    width: twill_core::utilities::Width,
    custom_properties: &[(&str, f32)],
) -> Option<ResolvedWidth> {
    match width.size()? {
        twill_core::utilities::Size::Spacing(spacing) => {
            Some(ResolvedWidth::Length(Length::Fixed(spacing_to_px(spacing))))
        }
        twill_core::utilities::Size::Percentage(fraction) => {
        ...
        twill_core::utilities::Size::Container(container) => Some(ResolvedWidth::Length(
            Length::Fixed(container_to_px(container)),
        )),
        twill_core::utilities::Size::Auto => Some(ResolvedWidth::Length(Length::Shrink)),
        twill_core::utilities::Size::Full
        | twill_core::utilities::Size::ScreenWidth
        | twill_core::utilities::Size::ScreenHeight
        | twill_core::utilities::Size::Dvw
        | twill_core::utilities::Size::Dvh
        | twill_core::utilities::Size::Lvw
        | twill_core::utilities::Size::Lvh
        | twill_core::utilities::Size::Svw
        | twill_core::utilities::Size::Svh => Some(ResolvedWidth::Length(Length::Fill)),
        twill_core::utilities::Size::Prose => Some(ResolvedWidth::Length(Length::Fixed(520.0))),
        twill_core::utilities::Size::MinContent
        | twill_core::utilities::Size::MaxContent
        | twill_core::utilities::Size::Fit
        | twill_core::utilities::Size::Lh => Some(ResolvedWidth::Length(Length::Shrink)),
        twill_core::utilities::Size::Var(var) => custom_properties
            .iter()
            .find(|(name, _)| *name == var.as_str())
            .map(|(_, px)| ResolvedWidth::Length(Length::Fixed(px.max(0.0)))),
        twill_core::utilities::Size::HeightVar(_) => None,
        twill_core::utilities::Size::Px(px) => {
            Some(ResolvedWidth::Length(Length::Fixed(f32::from(px))))
        }
    }
}

pub(crate) fn resolve_height(
    height: twill_core::utilities::Height,
    custom_properties: &[(&str, f32)],
) -> Option<ResolvedHeight> {
    match height.size()? {
        twill_core::utilities::Size::Spacing(spacing) => Some(ResolvedHeight::Length(
            Length::Fixed(spacing_to_px(spacing)),
        )),
        twill_core::utilities::Size::Percentage(fraction) => {
            if matches!(fraction, Percentage::Full) {
        ...
        twill_core::utilities::Size::Container(container) => Some(ResolvedHeight::Length(
            Length::Fixed(container_to_px(container)),
        )),
        twill_core::utilities::Size::Auto => Some(ResolvedHeight::Length(Length::Shrink)),
        twill_core::utilities::Size::Full
        | twill_core::utilities::Size::ScreenWidth
        | twill_core::utilities::Size::ScreenHeight
        | twill_core::utilities::Size::Dvw
        ...
        | twill_core::utilities::Size::Lvh
        | twill_core::utilities::Size::Svw
        | twill_core::utilities::Size::Svh => Some(ResolvedHeight::Length(Length::Fill)),
        twill_core::utilities::Size::Prose => Some(ResolvedHeight::Length(Length::Fixed(520.0))),
        twill_core::utilities::Size::MinContent
        | twill_core::utilities::Size::MaxContent
        | twill_core::utilities::Size::Fit
        | twill_core::utilities::Size::Lh => Some(ResolvedHeight::Length(Length::Shrink)),
        twill_core::utilities::Size::Var(var) => custom_properties
            .iter()
            .find(|(name, _)| *name == var.as_str())
            .map(|(_, px)| ResolvedHeight::Length(Length::Fixed(px.max(0.0)))),
        twill_core::utilities::Size::HeightVar(var) => custom_properties
            .iter()
            .find(|(name, _)| *name == var.as_str())
            .map(|(_, px)| ResolvedHeight::Length(Length::Fixed(px.max(0.0)))),
        twill_core::utilities::Size::Px(px) => {
