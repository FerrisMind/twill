...
impl private::Sealed for twill_core::tokens::ColorValue {}
impl ToSlint for twill_core::tokens::ColorValue {
    type Output = slint::Color;
...
pub fn to_slint_color_value(value: twill_core::tokens::ColorValue) -> slint::Color {
